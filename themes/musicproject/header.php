...
<body <?php body_class(); ?>>
    <div class="youtube-video w-full h-full max-w-[500px] max-h-[310px] flex flex-col fixed z-10 bottom-0 right-0 p-5">
        <div class="close-icon cursor-pointer close-video-js hidden py-2">
