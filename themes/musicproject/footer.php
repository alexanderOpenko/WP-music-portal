...
<div class="flex items-center justify-center p-4 bg-[#89CFF0]">
  <div class="flex items-center">
    <span>
      Developed by
    </span>

    <h3 class="m-0 ml-2 leading-[0px]">
      Alexander Openko
    </h3>
  </div>

  <div class="ml-2">
    <a class="normal-link" target="blank" href="https://www.instagram.com/openkoalexander/">
      <div class="icon mb-[-1px]">
